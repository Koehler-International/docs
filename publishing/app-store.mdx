...
This guide walks you through publishing your MobileCoder app to the Apple App Store. You'll need a Mac with Xcode and an Apple Developer account.

<Warning>
Before starting, make sure you've completed the [Xcode Setup](/publishing/xcode-setup) guide.
</Warning>
...
1. Open your project in Xcode (see [Xcode Setup](/publishing/xcode-setup))
